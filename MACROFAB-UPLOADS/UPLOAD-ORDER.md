...
3. Confirm the Design Rule Check shows the Standard lane: 10 mil plated drill, at least 5 mil copper spacing, and at least 10 mil copper-to-edge clearance. This revision uses a thin outline plot and a 16 mil copper keepout to leave importer margin.
...
6. Set every component to MacroFab-supplied inventory; do not select customer-supplied parts. U1 is the sourceable SOIC part `PIC16F1459-I/SO`.
...
8. Before ordering, visually verify the bottom-side placement and rotation of J1 (USB-C), U1, RN1, and RN2. J1's mating face must project slightly into the center of the right-side accessory/headphone-adapter recess.
